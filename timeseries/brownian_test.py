...
import numpy as np
import mdtraj as md
from LLC_Membranes.analysis import residues, Structure_char
...
def restrict_to_pore(t, com, r, npores=4, ref_atoms=['C', 'C1', 'C2', 'C3', 'C4', 'C5'], ref_frame=-1):
    ...
    pcenters = Structure_char.avg_pore_loc(npores, t.xyz[:, ref, :], 0)
...
if __name__ == "__main__":
    ...
    for i in range(3):
        ...
        ax[i].plot(x, gaussian(x, popt[0], popt[1]))
        ax[i].set_xlabel('Deviation (nm)')
