...
Machine Learning Approaches to Transport Characterization :code:`LLC_Membranes.machine_learning`
-----------------------------------------------------
...
.. table::
   ...
   |   Script Name                                       | Description                                                            |
   +=====================================================+========================================================================+
   |:ref:`infinite_hidden_markov_model.py <hdphmm>`      | Automatically identify hidden dynamical modes                          |
   +-----------------------------------------------------+------------------------------------------------------------------------+
