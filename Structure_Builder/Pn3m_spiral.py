...
#NOTES: Perpendicularization of the outer layer is set to half the normal, not the full
      # The inner ring has 2 more layers than the outer ring
      # The top and bottom layers of the inner ring have 1 monomer
      # Junctions are extra spread (lines 584 - 587)
      # Removed curve from inner spiral (lines 190, 200)
