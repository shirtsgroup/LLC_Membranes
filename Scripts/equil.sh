...
gmx editconf -f initial.gro -o box.gro -c -bt triclinic -box 13.5 13.5 8.5 -angles 90 90 60
...
for f in 3162 56 8 3 2 1 0; do
	restrain.py -f ${f} -A xyz -r on -D off -w off --novsites -m NAcarb11V -a C C1 C2 C3 C4 C5
	restrain.py -f ${f} -A z -r on -D off -w off -g initial.gro -m NAcarb11V --append -a C20 C34 C48
