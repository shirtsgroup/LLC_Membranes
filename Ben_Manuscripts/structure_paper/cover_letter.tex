...
\begin{document}
	...
	%MRS: don't need to put they are graduate students or postdocs.
	%BJC: but it says to do that in the author's guide 
	...
	%BJC: says to do that in author's guide
	...
	\begin{enumerate}
        ...
        % MRS: osuji might be a conflict of interest due to supervising Xunda recently plus
        % joint grants with Gin, but I don't know for sure. Can leave him on for now.
		...
		% BJC: Yethiraj is an editor so can't use him
...
%		\href{mailto:yethiraj@chem.wisc.edu}{yethiraj@chem.wisc.edu})  
		% questionable due to related self-assembly research. 
		% MRS: I looked over his recent papers, and I think will be OK.
	\end{enumerate}
