...
%  \end{figure}
  ...
  An isotropically aligned system the refelctions would appear as 
...
%  \end{table}
  ...
  \begin{itemize}  %BJC: working on the following. The following is what I expect
	...
	crosslinked  % probably smaller
	\item We simulated the crosslinked simulations in the NPT ensemble for 100 ns
	\item Major features are still present in the X-ray diffraction ~\ref{fig:rzplot_xlink} % BJC: maybe
	\item The ionic conductivity is higher/lower in the crosslinked system ~\ref{fig:ic_xlink} % BJC: Nernst-Einstein is lower. Need a longer simulation to check Collective-Diffusion 
  \end{itemize}
  ...
  \begin{subfigure}{0.45\textwidth}
	\centering
	\includegraphics[widht=\textwidth]{rzplot_xlink.png}
