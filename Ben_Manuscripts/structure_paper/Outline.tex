...
%     monomers in each layer are positioned with respect to other layers. 
   ...
   \end{itemize}
    \end{enumerate}
%MRS2: size and how well defined the pore is (how suddenly the RDF changes in the pore) is also a question.

%MRS2: hmm.  This last point still seems somewhat relevant.  Why left out?
%BJC: I thought we agreed to leave this out. It lengthens the paper and makes it
% more confusing. Unless we just want to hint at it. 
...
%  \end{itemize}
  ...
  % Put in introduction towards end 
...
%BJC: okay will work on some figures illustrating the affect of initial choices on results

% BJC: Paragraph saying what choice we had to make when placing monomers
% BJC: Say which ones matter - don't forget number per layer
% BJC: expand on the ones that do matter. 
...
%BJC: okay, I have some ideas for this
...
%BJC: maybe not, we'll have to talk to get on the same page
  \begin{figure}
 	\centering
