...
%  \end{itemize}
  ...
  % BJC4: I will add 6 mon/layer disordered data once I have it.
  \begin{figure}
	\centering
...
%BJC4: I'm not sure what the best way to set up this figure is yet.
  ...
  \begin{itemize}
    ...
    %BJC4: So a combo of: domain misalignment, slow dynamics of simulated system, only 4 pores
    % in unit cell, tortuosity (?)
	    ...
	    \item We will explore R-$\pi$ in more detail in Section~\ref{section:rpi}.
			...
			%BJC: Might have something to do with the distibution of tilt angles in the tails
