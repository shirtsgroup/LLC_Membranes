...
layered_disordered = [4.05, 4.26]
layered_disordered_err = [0.14, 0.224]
offset_disordered = [4.032, 4.31]
offset_disordered_err = [0.07, 0.18]
...
plt.bar([p + 2*width for p in pos][1:3], layered_disordered, width, label='Sandwiched (d=5)', yerr=layered_disordered_err)
plt.bar([p + 3*width for p in pos][1:3], offset_disordered, width, label='Parallel Displaced (d=5)', yerr=offset_disordered_err)
