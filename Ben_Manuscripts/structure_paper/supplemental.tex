...
\begin{document}
  ...
  \begin{enumerate}
	  ...
	  portion of the equilibration procedure. Since position restraints, the
	  simulations are run in the NVT ensemble. When layer spacing is large, such as
	  ...
	  equilibration times, and it will almost certainly remain trapped in metastable
	  configurations that bear no resemblence to experimental profiles. 
 
	  \begin{figure}
		\centering
		\includegraphics[width=0.5\textwidth]{dbwl_10.png}
		\caption{}\label{fig:dbwl_10} 
	  \end{figure}
