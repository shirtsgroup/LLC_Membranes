...
%MRS12: I think it is useful to put in just to show we've been thinking about them.  Can omit the figure in the main text.
 One way toproduce R-double if our initial configuration contains alternating parallel and
...
%  carboxylate bond would be sterically hindered. 
  ...
  QM studies of stacked $\pi-\pi$ systems that such uneven stacking could be energetically stable.
