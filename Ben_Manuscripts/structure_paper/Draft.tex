...
%  columns\cite{chaikin_principles_1995}. 
  ...
  %BJC11: need to rephrase -- "strongly suggests" used two paragraphs prior
...
%  groups within the same column. 
  ...
  not surprising since GAFF models atoms as point charges and  % BJC11: need reference
...
%  agreement with experiment.
  ...
  %BJC11: ^ Not sure this is counterintuitive to people thinking in reciprocal space.
...
%MRS10: I wonder if it would be better to lead with what we think IS the answer, and then rule out other effects.  
  ...
  Adding water to the system appears to promote the appearance of R-double,
