...
%MRS13: we might end up adjusting the author list a bit; I will ask Matt where he thinks he and Joe should go.  I will talk to Rich when we get this going; not clear that he actually has contributed.  But that's my job. 
  ...
  to perform complex aqeuous separations with seawater and various sources of
  wastewater. Sodium chloride and boron in seawater, and organic micropollutants
  found in municipal and industrial wastewaters are a few examples of the
  diversity of components that make up various water sources. By efficiently
  ...
  thus lowering the energy requirements of the separation processes.
...
%  valuable resources which can be separated using highly selective membranes~\cite{sales_resource_2015}.
 ...
 % (2) existing nanoporous membranes + drawbacks
  ...
  selectivity. Although scalable, their fabrication involves the spontaneous
...
%		  with vertically aligned nanopores}~\label{fig:soft} \end{figure}
  ...
  specific separations. Over the past 20 years, H\textsubscript{II}-phase LLC
