...
%  that it does not appear in our simulated patterns in Section~\ref{section:rdouble}.
  ...
  %BJC5: maybe show in supplemental?
...
%  \end{figure}
  ...
  % BJC5: Trying using inverted fourier transform of 2D experimental waxs. See what z-cross-section
  % looks like (does it oscillate more or less?) Then take FT of that and compare its intensity
  % to simulated intensity
...
% line is thickest. That way, when the outlines overlap, you can see the ones in front.
  ...
  conductivity since we believe its structure is the closest match to
