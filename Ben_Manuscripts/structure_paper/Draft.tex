...
\begin{document}
  ...
  Figure S~\ref{S-fig:monomer_color_coded}
...
%  information.
  ...
  \subsubsection{Density of monomers around pores}
  ...
  \begin{figure}
	...
	\includegraphics[width=\linewidth]{p2p.png}
        ...
        % BJC3: I have that in the supplemental information. I could move it into the main
        % body. I think it would be best in the intro where I pose the question of parallel 
        % displaced v. sandwiched.
...
%  \subsubsection{Relative interlayer head group orientation}
  ...
  to experiment. We tested systems built with 5 monomers per layer in the parallel 
  displaced and sandwiched configurations at 300K. We generated simulated patterns using 
  portions of simulation trajectory after equilibration. The patterns for both 
  structures are shown and compared to experiment in Figure~\ref{fig:XRDsim}.

  Simulated XRD of the sandwiched configuration shows most all experimental features 
  except R-helix and R-spots. R-pores and R-alkanes appear in their expected locations. 
