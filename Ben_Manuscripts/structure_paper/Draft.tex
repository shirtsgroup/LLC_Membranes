...
\begin{document}
  ...
  A highly selective membrane can be useful for the recovery of valuable
...
%BJC: but wouldn't the free energy just be a function of all the factors I list? 
%Maybe I can rephrase it that way: "A solutes ability to enter a given membrane barrier is governed by the free energy to partition into the membrane which is influenced by ..."
...
%  earlier. R-$\pi$ and R
  ...
  on top of them (Figure blah blah blah). This type of packing has been seen
...
%  \end{table}
  ...
  %BJC: Matt thinks this section is necessary
