...
%  \end{figure}  
  ...
  %MRS11: probably want to say about about HOW they were generated (Could refer back to methods?)
  %MRS11: my pass below.
  There are two important factor to take into account when looking at differences between experimental XRD and simulated XRD.  First, the 
  simulated diffraction patterns have some noise, especially
  along the $q_z$ axis at $q_r$=0, which is where several of the more interesting features are located.
  This is due to the angle averaging the 3D structure factor around the $q_z$-axis (see section~\ref{method:xrd}), meaning there are fewer samples as  $q_r$ approaches 0. The amount of samples to converge along the $q_z$ axis is analyzed in Supporting Information section S-\ref{S-section:xrd_noise}. 
  More importantly, are simulations do not appear to be long 
  enough to sample 
  truly independent configurations within their respective metastable basins
  (See section~\ref{section:slow_dynamics}), meaning we must take care in interpreting the results of the XRD. 
...
The simulated patterns generated for all systems
  ...
  In the next few subsections, we have individually address each major reflection, and the similarities and differences between simulation and experiment. We start with relatively 
  uncomplicated analyses of reflection that are very similar between experiment and simulation:
  %BJC10: Could make the following more descriptive. For example : "The location of R-alkanes", "The intensity of R-pores", "The origin of R-spots", "The shape and intensity of R-pi", "The origin of R-double".
  %MRS11: that sounds good.
  \begin{itemize}
...
%  columns\cite{chaikin_principles_1995}. 
  ...
  %BJC10: I could integrate a 3D correlation function to get a better value
  ...
  \subsubsection{R-pores}\label{section:rpores}
   ...
   %BJC10: trying to come up with a good explanation.   
...
%  origin of R-spots.
  ...
  %BJC10: I only addressed this because Matt wanted a more thorough characterization of tail order 
