...
%  close to experiment.   
  ...
  %BJC5: need to make parallel displaced and sandwiched configurations clear in methods
  ...
  %BJC5: integrate supplemental section labels into main paper.
  ...
  (Figure~\ref{fig:SAXS}).
  %BJC5: comment about disordered systems
  ...
  %BJC5: edit above with consciencenous of new 6 mon/layer sim data
  ...
  \begin{figure}
	...
	\caption{Systems with 5 columns per pore have equilibrated pore spacings closest to
			 ...
			 %BJC5: double check this statement once all data is present
  ...
  %BJC5: This could potentially supplement parts of the qualitative descriptions.
  ...
  equals 1.
  % BJC5: above is stated in methods. Not sure if it needs to be restated.  
  % BJC5: I need to explain how I calculated these intensities somewhere. Is this the right
  % place to do it? I think it would just be confusing in the methods. I could also move it
  % to supplemental.
  % BJC5: Definitely need demonstrative figures in supporting info.
