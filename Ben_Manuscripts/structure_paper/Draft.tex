...
% the software I used to create it
  ...
  phase is a simpler starting point. The system has no water which allowed us
  ...
  \begin{enumerate}
    ...
    %BJC5: changed to 'many liquid crystalline systems'
 	...
 	hexagonal array of pores (xy plane) and short range z-direction correlations between 
        stacked columns of monomers. In this study, we use our atomistic molecular model
	...
	ambient water are leached into the system. The hydrogen bonding network formed by the 
...
%  to experiment. We believe systems built with 5 columns per pore achieve this goal.
  ...
  Monomers in disordered basin systems built with 6 columns-per-pore agree with experiment 
  within error, but stack too far apart. Those in the disordered sandwiched and disordered
  parallel displaced configurations stack $\approx$ 4.87 and 4.94 \AA~apart respectively, 
