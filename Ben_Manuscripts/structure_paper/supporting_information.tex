...
\begin{document}
  ...
  generated using Packmol (\cite{martinez_packmol:_2009}). The input file given to 
  Packmol is shown below.
  ...
  observe any progress towards an system ordering.
  
  %BJC: picture of isotropic box (before and after?)
  %BJC: plot of nematic order parameter vs. time 
