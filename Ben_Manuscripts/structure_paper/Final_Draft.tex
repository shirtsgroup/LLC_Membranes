...
% BJC: in --> for
  ...
  In this study, we achieve a more realistic atomistic description of a
  %BJC: of --> of a
 ...
 \begin{enumerate}
  ...
  %BJC: show a united-atom --> that a united-atom ; of LLC --> of an LLC
  ...
  %BJC: a variety of automated --> automated
...
\begin{table}[h]
  ...
  %BJC: removed this sentence since I do parallel displaced config in the ensemble
  %We limit this discussion to the sandwiched configuration since it is not
  %feasible for columns in the parallel displaced configuration, as we have set
  %them up, to move past each other. 
  ...
  %BJC: added figure reference below. Check that it works
  ...
  %BJC: seems redundant from last sentence of above paragraph
