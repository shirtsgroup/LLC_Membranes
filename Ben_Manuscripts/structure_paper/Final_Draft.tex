...
\begin{document}
 ...
 \begin{enumerate}
  ...
  head groups. 
  %We measured the pore radius as the average distance from the pore
  %center to each head group COM. 
...
\begin{table}[h]
  ...
  our forcefield may in part be responsible for the tendency of monomers to stay
...
%  \end{figure}
  ...
  %BJC: I could move the following paragraph to supporting information since it
