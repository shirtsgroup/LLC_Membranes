...
%  of the Donnan potential. 
 ...
 \begin{enumerate}
  ...
  Since liquid crystals exist in a wide range of shapes and sizes, including candidate
...
\begin{table}[h]
  ...
  (see Section \ref{S-section:tail_tilt} of the SI). 
  ...
  Section~\ref{S-section:correlation_functions} of the SI. We calculated the
...
%  as outline in Section~\ref{S-chain_packing} of the SI but saw no improvement
%  in packing distance.  
...
%  \end{figure}
  ...
  film to which we are comparing~\cite{feng_scalable_2014}. Additionally,
  the parameters for sodium ions in this system exhibit bulk water diffusion 
  coefficients that are two times greater than experiment ~\cite{bruce_molecular_2002}.
  We cannot definitively say exactly how this ratio changes in the confined LLC pore
  environment, but it is likely that sodium diffuses faster in our system which
  contributes to a higher ionic conductivity than experiment.
