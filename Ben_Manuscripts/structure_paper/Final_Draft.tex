...
\begin{document}
 ...
 \begin{enumerate}
  ...
  Section \ref{S-section:python_scripts} of the SI.
...
\begin{table}[h]
  ...
  %MRSF2: These next two sentences gets pretty confusing; too many clauses, if, when, since . . . make sentences shorter. 
  ...
  %MRSF2: broke up the sentence, check to make sure it makes sense.
  ...
  characteristics that do not vary significantly with time.  We therefore attempted to learn
  more about their time-averaged structures by studying ensembles of shorter 
  simulations started from more independent initial configurations. To do this, we created
  ensembles of 40 simulations in both the parallel displaced and sandwiched 
  configurations. We used the same equilibration scheme described in Section~\ref{section:equilibration}. 
  However, we built the initial 
  ...
  The only difference between each independent initial configuration
  ...
  directed by the randomized velocity vectors of the system's atoms drawn from
...
%  \end{subfigure}
  ...
  range since hydrophilic regions of monomers can hydrogen bond, thus increasing the energetic 
  barriers for motion. We measured the diffusion constants of monomers in each of the main 
