...
sites to move to in Basin A. In all cases, our calculated values
are higher than experimental values, as expected. Some of the 
discrepancy is likely a result of using an imperfect forcefield. However, the real system, 
although mostly aligned and straight, has a distribution of 
azimuthal angles. This means that the pores have a degree of tortuosity 
which lowers the effective ionic conductivity of the bulk 
