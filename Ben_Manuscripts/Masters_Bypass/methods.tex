...
\begin{figure}
	...
	\begin{subfigure}[b]{0.475\textwidth}
		\centering
		\includegraphics[width=\textwidth]{sandwiched_layers.png}
		\caption{}\label{fig:sandwiched_layers}
	\end{subfigure}
	\begin{subfigure}[b]{0.475\textwidth}
		\centering
		\includegraphics[width=\textwidth]{offset_layers.png}
		\caption{}\label{fig:offset_layers}
	\end{subfigure}
