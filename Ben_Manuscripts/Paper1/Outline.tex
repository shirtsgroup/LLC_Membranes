...
%     space} available for membrane design  %BJC: redundant
  ...
  model of a specific LLC membrane with sufficient experimental characterization. %BJC: ample too much?
    \begin{itemize}
...
%     metastable state associated with a given LLC system.
  ...
  \begin{itemize}
        ...
        symmetry of the packed pores. The same information is obtained using a SAXS
...
%  \end{itemize}
  ...
  We chose an initial layer spacing based on R-$\pi$.
  \begin{itemize}  
    \item Each monomer was rotated so the plane of the aromatic ring on the
    head groups would be parallel to the xy plane.
...
%  \end{itemize}
  ...
  that they were asked.  %BJC: I dont like this
  ...
  \begin{itemize}
	...
	\item All systems are stable after 50 ns of simulation.  % BJC: edited this for clarity
	...
	%BJC: It looks like the 7 and 8 monomer systems were only run for 50 ns. The 4 monomer system was run for 200 ns. 5 and 6 have a lot of data. 7 and 8 flattened pretty quickly, so at the time I figured it wasn't worth continuing. But I'll extend them just to be thorough.
