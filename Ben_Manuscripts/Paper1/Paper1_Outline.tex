...
%MRS: possibly we want to look at the more detailed X-ray diffraction patterns, but that may not be feasible on the timescale.
	...
	\begin{itemize}
		...
		\item My monomer form two types of self assembled LLCs - thermotropic (Colh) and lyotropic (HII) - explain difference % actually explain 
...
%BJC: don't explicity say azimuthal
