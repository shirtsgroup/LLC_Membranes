...
%BJC2: Just noticed this comment before sending it back to you. I'll look at the grant again while editing the next iteration. I think I want to move away from framing the membrane as just a desalination membrane
%MRS3: I agree - desalination is one possible use, but its more about transport / structure in general.
...
\begin{document}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Does concentration of ions in the pore repel incoming ions?
               %MRS3: add potential reasons for transport  about non-ionic solutes as well.           
		\end{itemize}
	\end{itemize}
	...
	\begin{itemize}
		...
		\item The Colh phase is described as having pores made of disks or layers stacked on top of one another, each containing a set number of monomers. 
                  %MRS3 rewrite next line to reflect how the thesis will be stated in the paper.
	...
	\begin{itemize}
		...
		\item 5 layers create micellar structure %MRS3: specify.
...
%BJC3: Maybe i include this in the supplemental information. I don't think a picture of the initial configuration is actually that interesting or important 
...
%MRS3: what is the thesis of the figure -- what is it trying to show.  Important when analyzing the outline and deciding what it means.  Make that the caption.
		...
		\item System validated using multiple monomer configurations 
                  %MRS3: be mroe precise what ``validation'' means.
		...
		\end{itemize}
                %MRS3: see above on putting in thesis and what you are trying to convince readers.
	...
	%BJC2: I'd like to talk to you more about some calculations before I form a thesis. And that will guide the rest of this paragraph 
        %MRS3: great, we'll talk tomorrow.  If it is disordered, then there are two kinds of disorder people weren't really talking about -- disorder in the z direction, and disorder in the radial direction.
	\begin{itemize}
...
%MRS3: write as it will appear in the paper.  Add ``will be done'' notes in comments.
...
%MRS3: aha, this here below is a thesis, something you are convincing the reader is true.
There are no clear layers despite the defined layers in the starting configuration.
	...
	The procedure used to create and validate our model can be used to evaluate other liquid crystalline assemblies
        %MRS3: I don't think we really need to explore all the other possibilities - just that it allows for design of new nanoporous membranes. 
	\begin{itemize}
...
%MRS3: probably don't need to talk about this, since we don't present these results.
	...
	%BJC2: after where we talk about disordered pores?
        %MRS3: sure, sounds good.   LEt's talk about what resolution on pores we can get from simulation.	
	...
	\begin{itemize}
		...
		\item 7 monomer per layer configurations  %MRS3: and others if needed.
	\end{itemize}
	
	\noindent Crosslinking details
	\begin{itemize}
          %MRS3: we can decide, but enough detail to replicate.  Should have the code in a repository that can be distributed.
		\item Full algorithm? or just detailed description
		\item Maybe a figure showing the new crosslinks %MRS3: yes.
	\end{itemize}
