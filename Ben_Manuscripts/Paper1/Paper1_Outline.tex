...
%via simulations). I don't know that we can answer that question which is why I didn't pose it in the intro	
	...
	\begin{itemize}
		...
		\end{itemize}
		%BJC - I'm going to cut this since I cannot answer this question definitively - unless we take an approach based on enthalpy differences and structural comparisons (pore-to-pore distance and x-ray scattering data). We probably have enough information for a speculative answer, but I don't know if that should be included in the paper
