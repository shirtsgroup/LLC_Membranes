...
%  water and any resultant influence it might have on mechanistic properties.
  ...
  water model that GAFF and other AMBER family parameters have been optmized
  with.~\cite{florova_explicit_2010} %~\cite{mahoney_five-site_2000}
...
%  head group positions are uncorrelated.
  ...
  % Changing does not change conclusion here.
  ...
  5 wt\% versus the 10 wt\% water system (see Figure~\ref{fig:component_densities})  %BJC: this is the RDF figure of head groups, tails, sodium, water 
...
%  The reason for this anomaly is twofold. 
