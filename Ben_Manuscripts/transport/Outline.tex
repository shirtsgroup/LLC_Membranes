...
%MRS1: Seems like transport should be somewhere in the title. 
...
%  \end{itemize}
  ...
  %MRS2: distribution is more common.
...
%    concentration (See section~\ref{S-section:coord_number} of the SI)
  ...
  % MRS2: couldn't hurt, would provide more context.
  \begin{figure}[!htb]
  \centering
...
%  \end{itemize}
  ...
  \begin{itemize}
    ...
    %MRS2: is it all the way in the tail region?
