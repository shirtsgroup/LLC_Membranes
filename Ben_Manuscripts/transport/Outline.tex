...
%  described in our previous work. 
  ...
  \noindent We measured the time-averaged mean squared displacement (MSD)
  of the centers of mass of each solute over the course of 1 $\mu$s MD 
  simulations using Equation~\ref{eqn:tamsd}.
  \begin{itemize}
    \item \begin{equation}
...
%  \end{itemize}
  ...
  \subsection*{Structure and Transport of Membrane Components}\label{section:membrane_components}
  ...
  \begin{itemize}
    ...
    \item Sodium ions are densest within the pore region, which we define as the
    space between the pore center and the peak head group density.
  ...
  The MSD of sodium and water become linear on long timescales.
  \begin{itemize}
    \item
  \end{itemize}
  ...
  \end{subfigure}
  \caption{}\label{fig:msd_comparison}
  \end{figure}
  
  Sodium coordinates with water.
  ...
  \begin{itemize}
  	\item We plotted the solute size against their MSDs in Figure~\ref{fig:all_msds}.
  ...
  \includegraphics[width=\textwidth]{all_10wt_tamsds.pdf}  % include bar plot of MW to show it's non-monotonic
  \caption{}\label{fig:all_msds}
  \end{subfigure}
  \begin{subfigure}{0.5\textwidth}
  \includegraphics[width=\textwidth]{msd_radius.pdf} 
  \caption{}\label{fig:msd_radius}
  \end{subfigure}
...
%  \bigskip
  ...
  \begin{itemize}
    ...
    periods of entrapment generally occur when solutes are far from the pore
    center.
    ...
    %BJC: need a radial density of head groups, tails, water etc.
    \item Solutes can move relatively freely when they enter the pore region
    which is primarily composed of water molecules.
  \end{itemize}
  ...
  \begin{itemize}
    ...
    with water. 
    \item This shows a high perference for the carboxylate anions since there
...
%  \end{figure}
  ...
  \begin{itemize}
    ...
    linearly as expected form the Stokes-Einstein relationship  % BJC: maybe better to use wilke-chang version with correction factor
...
%  It can easily reform the second hydrogen bond in close proximity
  ...
  \begin{itemize}
  	...
  	however they are both larger molecules. %BJC: not sure how far I should dive into this point
  \end{itemize}  
