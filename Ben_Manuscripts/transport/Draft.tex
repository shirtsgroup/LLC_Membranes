...
%  \tiny
  \begin{tabular}{ |lcclcc| }
    \hline
    Name & Abbreviation & Structure & Name & Abbreviation & Structure \\ \hline
    
	\color{blue}{Methanol} & \color{blue}{MeOH} &     
    \begin{minipage}{.1\textwidth}
    \includegraphics[width=\linewidth]{structures/methanol.png}
    \end{minipage} \\
...
%    \begin{tabular}{ | l c c | }
%    \hline
%    Name & Abbreviation & Structure \\ \hline
...
%  where 
 ...
 \% water system.
  ...
  confined to the pore region. In Figure~\ref{fig:water_msd_comparison}, we 
  constructed the MSD curves based on water molecules that spent > 95\% of their
  time in the pore region. If we instead restrict our calculation to water molecules
  that spend > 95\% of their time in the distal tail region, the MSD of distal tail
  water decreases 8-fold compared to pore water.
  ...
  which stay in the pore region. The MSD of distal tail water molecules is 1.71 nm$^2$,
  which is actually higher than that of pore water. This anomaly is likely a consequence
  of low density in the distal tails as well as structuring of water molecules. 
  Water molecules are less likely to interact via hydrogen bonding while in the distal 
  tail region since they are interspersed between chains, while they are in close
  proximity in the pores.
  % BJC: quantify this. Number of hbonds per frame. 
...
%  entrapment usually occur when solutes are far from the pore center.
  ...
  every timestep. Voloshin et al. studied hydrogen bonding on multiple timescales and 
  observed exponential behavior on the longest timescales~\cite{voloshin_hydrogen_2009}. 
  We do not collect data frequently enough to provide a sufficient answer to this 
  question so we instead report the 95\textsuperscript{th} percentile of hydrogen bond dwell times.
  This places emphasis on solutes with long dwell times.
