...
%  \end{itemize}
  ...
  One can instead focus on designing head groups with varying hydrogen bonding
  ...
  have many hydroxyl groups. Conversely, one can decrease the number of hydrogen
  bond sites, or replace them with weaker hydrogen bonding atoms like nitrogen, to
