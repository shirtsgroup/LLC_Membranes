...
\begin{document}
  ...
  %MRS3:
  candidates
  for selective separation membranes. 
  %MRS3: I do worry that the above makes it look like we are not acknowledging the formulation problems.  Maybe something like: 
  %''models of how chemically selective separation membranes could can function''?  So the focus is more on the science that these membranes could reveal, rather than saying they are good membranes now?  Then we talk about new membranes at the end of the introduction. Thoughts? I didn't go ahead and make  the change since it needs a bit more thought.  I'm open to other ways to reformulate.  Some of this thinking will percolate into the rest of the introduction as well.
