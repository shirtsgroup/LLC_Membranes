...
%  \end{itemize}
  ...
  educated guess-and-check framework. An array of solute-membrane interactions
  ensuing from the chemically complex and inhomogeneous LLC membrane structure
  as well as the complexity of the solutes themselves, have hindered the 
  establishment of firm design criteria. Our atomistic modeling approach gives
  us the opportunity to approximate these interactions at the molecular scale
  so that we can observe them and think more critically about LLC membrane design. 
