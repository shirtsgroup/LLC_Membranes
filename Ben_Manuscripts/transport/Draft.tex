...
%  membranes.~\cite{zhou_supported_2005}
  ...
  design of LLC monomers 
  %MRS4: 
  %can 
  have the potential to 
  help us tailor membranes for solute-specific
  separations.
  ...
  atomistic resolution so that we can directly 
  %MRS4: observe is strong, maybe describe? I'm open to other options.
  % observe 
  describe
  ...
  %MRS4: I kind of like it here.  We can tweak the text to be a bit shorter without losing meaninig.
  ...
  %MRS4: added for clarity
  In any case, we are more interested in mechanisms of interaction with specific chemical functionality more than the behavior of specific molecules.
