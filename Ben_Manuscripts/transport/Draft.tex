...
\begin{document}
  ...
  of an LLC membrane using atomistic molecular simulations. We found
...
%  compounds.
  ...
  First, we will comment on the membrane's structure. Previously, we have
  ...
  Then we will present our efforts to understand how small molecules, 
  ...
  pore region. We will study the gradient in composition of solutes and 
  water and any resultant influence it might have on mechanistic properties.
  
  Finally, and for the bulk of this work, we will present our observations 
  ...
  anticipate that transport will be hindered in some way. We want to understand
...
%  where 
  ...
  diffusivity to be 7.45e-07 $cm^2 / s$ which is only 1.4 \% that of bulk tip3p 
