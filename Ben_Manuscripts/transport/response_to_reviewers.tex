...
\begin{enumerate}
    ...
    %BJC2: restructured into single reason, since longer association times are a 
    % consequence of crowding.
    %New text: ``The reason for this anomaly is twofold. First, monomer head groups are
    ...
    wt\% water system (see Figure~\ref{M-fig:component_densities})  %BJC: this is the RDF figure of head groups, tails, sodium, water
    ...
    % MRS: but this next ``Second,'' doesn't explain why this slows things down more in 5%; 
    % just because the concentration of ions is higher?  But the concentration of water molecules is lower. 
%    This slow-down, caused by the high energetic barrier to diffusion, is exacerbated by 
%    simultaneously enhancing the favorability of interactions between water and monomer
%    components. 
...
%    As a consequence of this crowding, the diffusion of water molecules is even 
%    further slowed by longer periods of association with monomer components. %hydrogen bonds with other water molecules and association with sodium ions. 
%    Notably, there is a negligible number of hydrogen bonds between water molecules and monomer head groups.
    ...
    % BJC: incorporated MRS thesis suggestion
    ...
    % BJC: A second example  (water in the tails):
...
%    at 300K, the temperature of our simulations.``
    ...
    %BJC2: I used it because it has a comparison between physical properties exhibited by different water models inlcuding tip3p. 
    %MRS2: there have been a number of water model papers since then (look at TIP4P-Ew paper of Horn et al, OPC paper)
...
%  	112, 8910–8922
    ...
    %BJC2: incorporated point about pore size
    ...
    %MRS2: should also talk about where this is discussed in THIS paper.  We want to make sure people are 
    % visualizing what we are imagining when reading this paper.
    ...
    %BJC2: moved into paragraph above
...
%    discussion section.
    ...
    %BJC2: will ensure this before sending off
    ...
    % BJC2: I'm actually talking about the same simulation since I observed water in the 
    % tails of the water bath simulations as well. That's what inspired the other systems.
    ...
    % BJC2: moved to supporting. I don't think it adds much value here.
%    \begin{table}[!htb]
%    \centering
%    \begin{tabular}{|c|c|c|}
%    \hline
...
%    \end{table}
    ...
    %BJC2: I agree, removed from main document. 
%    \begin{figure}[!htb]
%    \centering
