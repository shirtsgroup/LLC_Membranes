...
\begin{enumerate}[label={Comment \theenumi :}, leftmargin=3.9\parindent]
    ...
    recent approaches we have developed within our research group.~\cite{coscia_capturing_2020} We would also prefer to have
...
%    our system which uses a monoclinic unit cell and has 2 dimensional order. 
    ...
    methodology. We have studied the structure of and transport of solutes within this 
    particular LLC system extensively in our previous work.\cite{coscia_chemically_2019} We feel strongly that our current work should 
