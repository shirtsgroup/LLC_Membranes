...
\begin{enumerate}[label={Comment \theenumi :}, leftmargin=3.9\parindent]
    ...
    %BJC2: added to make the point about our system being more complicated than those studied.
    ...
    %BJC2: maybe push back on the CS-DBP here? 
...
%(or minimally assumes - in some cases we assume pore vs. non-pore)
...
%BJC2: I believe I had orginally addressed this briefly as well. Feel free to expand if you feel there is more to be said
...
% BJC2: assuming this comment about CS-DBP?
    % MRS2: sorry, this was about OUR method, that it's definitely different because
    % the clustering is not confiugurations based.
...
% wouldn't have to try those modifications.
    ...
    (see~\ref{fig:membrane_side_profile}).
    \begin{figure}
    \centering
    ...
    Author reply: 
    %We thank the reviewer for posing this question as this a constraint to which 
...
\begin{enumerate}[label={Comment \theenumi :}, leftmargin=3.9\parindent]  
    ...
    % BJC2: shifted initial focus towards mechnistic understanding. Still kept part about speeding up simulations
    % as I think it's worth discussing ways to make this an actual high throughput technique. 
    ...
    quite long. 
    %The dynamics of the solutes are somewhat slow and we wanted to ensure we gathered
    %enough data for a sufficient parameterization. 
    ...
    %BJC2: do you think I should reword this at all to make it different?
