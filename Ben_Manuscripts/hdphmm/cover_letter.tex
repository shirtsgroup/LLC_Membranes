...
\begin{document}
	...
	of Physical Chemistry, specifically in section X of % BJC: the link with section titles is an unfinished webpage
	...
	materials. %BJC: this could be made more general. Maybe better focused for JPC though
	...
	(Coscia and Shirts, arXiv:2004.07905 [cond-mat.soft]). % BJC: is this the right way to cite arXiv?
	...
	%BJC: need at least 5 reviewers
	\noindent Some suggestions for reviewers are:
	\begin{enumerate}
	
	    %BJC: these are reviewers suggested for the first stochastic transport paper
	    %BJC: not sure if bad to use twice
		...
		\item Emily Fox?  % she made the HDP-AR-HMM
