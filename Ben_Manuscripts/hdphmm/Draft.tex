...
\begin{document}
  ...
  water system studied here, making this connection can be a relatively straightforward 
...
%    arbitrary size. 
  ...
  \end{subfigure}
  \caption{(a) Hydrogen bonds can be donated by methanol to the highlighted oxygen atoms in three 
