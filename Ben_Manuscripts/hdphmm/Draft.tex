...
%  Section~\ref{S-section:ihmm_procedure} of the Supporting Information.
  ...
  %BJC3: maybe could say something about multivariate guassian noise with VAR in cylindrical doesnt work with current code.
...
%  dimensions as the equilibration time point. 
  ...
  and $\lambda_x^2$ + $\lambda_y^2$ respectively. %BJC3: possibly could use some justification of these definitions. 
