...
\begin{document}
  ...
  solutes and the membrane. Along with parameters of individual states, the HDP-AR-HMM 
  ...
  Parrinello-Rahman 
  %MRS: just wondering, was this semiisotropic, or isotropic?  If isotropic, do we know how different the diagonals of the pressure tensor were (since the system is not totally isotropic)
  %BJC5: I use semi-isotropic (xy together and z separate)
...
%  \subsubsection*{Applying the HDP-AR-HMM to MD Trajectories} 
  ...
  emissions,  the variance in $A$ and $\Sigma$ parameters. In these cases, plateauing
  ...
  generated by the parameters of the HDP-AR-HMM (blue) show the same hopping
...
%  bear qualitative resemblance to the MD trajectories. 
  ...
  features of our MD simulations, we can now use realizations of the HDP-AR-HMM
