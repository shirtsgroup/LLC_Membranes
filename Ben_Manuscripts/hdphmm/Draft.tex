...
%  state for long enough for their positions to displace significantly.
  ...
  molecules and ions in the system, it is straightforward to hypothesize two types
...
%BJC4: the following has pretty all been replaced.
%  Most of what we 
...
%  
%  %BJC: I didn't put sodium ion association in this figure because it's infrequent. 
%  %BJC: If I compare to acetic acid or urea, I could add it back. I was thinking of splitting
