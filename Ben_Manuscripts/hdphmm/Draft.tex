...
% order to automatically detect and parameterize an unknown number of
%  latent vector autoregressive dynamical modes. 
  ...
  mechanisms in 
  %BJC2: porous nanoscale to nanoporous? 
  %porous nanoscale 
