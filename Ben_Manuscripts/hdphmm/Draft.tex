...
\begin{document}
  ...
  ability of the model, but it is also physically unrealistic and can complicate
  ...
  % BJC: he really wants use to emphasize our contribution with this part
  ...
  an infinite number of states, a Dirichlet process tends to exhibit a 
...
%  square $\mu_r$ converting it into the same units as $A$ and $\Sigma$.
  ...
  state assignments. This is only possible because the state sequence is fixed. 
...
%  Information, we provide a step-by-step illustration of the following process.  
  ...
  %MRS5: not clear what ``largest expected'' means here.
  %BJC6: modified to 'expected value' and referenced equation   
