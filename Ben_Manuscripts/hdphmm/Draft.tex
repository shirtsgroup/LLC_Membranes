...
%%  Information).
  ...
  %MRS: would it be accurate to show ``produces trajectories that show . . . ``  Saying that it ``can 
  %produce trajectories'' is a little weasly - sounds like it usually doesn't.  
  % 
  ...
  \begin{itemize}
    ...
    %MRS: should be clearer about what ``reproduce these curves mean'', since you aren't reproducing.
