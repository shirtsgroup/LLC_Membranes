...
%  \subsubsection*{Applying the HDP-AR-HMM to MD Trajectories} 
  ...
  diffusion constants 
  % MRS: maybe can say what the timescale of the linear regime, and how much 
  % longer the stochastic realizations are?
...
%  dwells times.
  ...
  \end{itemize}
  %MRS: above, start with the last point; state what the interactions are, and then give the reasoning.
  ...
  \begin{itemize}
    ...
    simulation time.  
    %MRS: this above doesn't support the thesis statement?
