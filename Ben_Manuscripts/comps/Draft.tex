...
%  \end{itemize}
 ...
 \end{wrapfigure}
  ...
  %MRS3: this is awkward; it's slow regardless of the timescales you can simulate. 
  %something like: slow dynamics longer than the timescales than can be reasonably simulated with current computer resources?
