...
%  require us to learn the equilibrium distribution of solutes in the membrane
  ...
  %BJC4: need figures to support these claims.
...
%  incorporate large jumps more frequently into the trajectories. 
  ...
  the shape of the MSD curves. Error in the MSD curvature can help explain some of
...
%  time in the tails likely due to its small size.
  ...
  %It is clear that the predictive
  %abilities of the MSDDM are inadequate but it is still possible to salvage
  %key insights.
