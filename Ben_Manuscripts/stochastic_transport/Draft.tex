...
%  \end{subfigure}
  ...
  Anti-correlation between solute hops has a significant effect on the scaling
  of solute flux with pore length. In Figure~\ref{fig:beta_hurst}, we show that 
  $\beta$, as derived from the sFBMcut model, is inversely related to the Hurst
  parameter while $\beta$, as derived from the MSDDM, shows no discernible
  trend.
