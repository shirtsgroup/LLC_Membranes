...
\begin{document}
  ...
  use our models in order to calculate flux of a given solute across a 
  macroscopic-length pore and, based on those quantities, the membrane's selectivity
  towards each solute. Overall, this work helps connect the relationship between
...
%  \end{equation}
  ...
  Equation~\ref{eqn:fbm_autocorrelation} to the first 10 0.5 ns time lags of the 
...
%  simulation procedure described in Section~\ref{method:model_sFBM}.
  ...
  For computational reasons dependent on the model used, we simulated 1000-10000 trajectory
...
%  additional solute trajectories. 
  ...
  the MD MSD curves. Improper curvature of the MSD curves cause the magnitude of
