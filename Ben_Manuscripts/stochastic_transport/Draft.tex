...
%  simulation procedure described in Section~\ref{method:model_sFBM}.
  ...
  time. 
  %MRS5: I would phrase below: 
  To account for input concentration dependence of the flux, assuming that 
  particles are uncorrelated, 
  %For particle concentrations higher than 1 at the pore entrance, 
  one can multiply
...
%  time in the tails likely due to its small size.
  ...
  %BJC4: methods?  
  %MRS5: This requires knowing the data, so maybe here. 
...
%  \end{subfigure}
  ...
  %MRS5: sentence fragment left here?
