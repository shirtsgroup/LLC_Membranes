...
\begin{document}
	...
	differences only in formatting.  % BJC: probably should include link (once I have one)?
	...
	%BJC: Should I just narrow down to three suggestions?
        %MRS: more is fine, but yes, if Klafter is univeristy president, pointless to include. Looking, it 
        %     looks like he finished as president last year, but probably not getting back to research soon.
        %     A review from JPCB woould be low on his priority list.
	...
	\begin{enumerate}
		...
		%BJC: Maybe not klafter because he hasn't published since 2015. It looks like he has been president of his university
                %MRS: yes, see above.
