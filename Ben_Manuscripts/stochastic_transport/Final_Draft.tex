\documentclass[aps,pre,preprint,groupedaddress,longbibliography]{revtex4-2}
\usepackage{CJK}
...
%  dimensional reduction which are often necessary to identify representative states.
  ...
  %BJC8: reformatted. I think this is what they want in terms of format
  %MRS9: tweaked 
  \begin{table}[!htb]
	  \centering
	  \begin{tabular}{ll}
...
%  only meaningful if the ensemble of solute trajectories is stationary.
  ...
  Gaussian and L\'evy stable distributions. Values of $\alpha_h$ are significantly lower for urea and acetic acid meaning 
  ...
  %BJC8: I thought that sFBMcut and sFLMcut implied which distributions I used. It's in Table I
  %MRS9: Maybe say ``both the Brownian (sFBMcut) and Levy (sFBMcut) version of both the one and two AD models''.  I think with the number of models floating around, it helps to be super explicit about what is being considered at any point.
...
%  The exact amount of data required is dependent on the solute studied. 
  ...
  %BJC8: I'm interpreting this as, "how does this information relate to design" 
  %MRS9: yes.
  ...
  donors. 
  %BJC8: something like this I think.   
  Therefore the transport rate of urea 
  %MRS9 tweak.
  %may be enhanced the most
  ...
  %BJC8: added following sentence
  %MRS9: as above, maybe ``modified'' is the best rather than enhanced?  Maybe we want to slow it down as well. 
...
%  however, in Figure~\ref{S-fig:flux_curve_sensitivity} of the Supplemental Material,
...
%  before  which implies that a coating of LLC membrane with a thickness on the 
...
%  optimal. 
  ...
  %BJC8: added a new paragraph after this one.
  %MRS9: looks good.
