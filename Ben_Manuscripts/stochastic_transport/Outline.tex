...
%  	learning algorithm which groups solute behavior into different dynamical states.
  ...
  \begin{itemize}
    ...
    %MRS: something simpler like ``sample the accessible mechanisms with representative probability''?
  \end{itemize}
  ...
  %MRS: this below sort of goes beyond standard use of MSM's though, right? where everything is usually constant-rate expoential processes? Should be explicitly mentioned.
