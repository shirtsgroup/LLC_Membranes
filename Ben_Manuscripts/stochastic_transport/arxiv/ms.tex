...
%  lower.
  ...
  %BJCB: I think the figures need to stay though   
  %MRSB: Hmm. I'm not entirely convinced, but we can leave it in for now and see what the reviewers think.
  \begin{figure*}
  \centering
  \begin{subfigure}{0.325\textwidth}
  ...
  % BJCB: I might be able to get away with moving this paragraph to SI if I briefly
  % mention the reason in the above paragraph.
  ...
  %hop distribution every time a mode switch occurs, the correlation
  %structure is broken. 
...
%  The exact amount of data required is dependent on the solute studied. 
  ...
  % BJCB: I could summarize the four following paragraphs in terms of key
  % takeaways, like you suggested with the AD model above.
...
%  \end{figure}
  ...
  %MRSB: discussion of parameter specifics is a potential place to move.
  \begin{figure*}
  \centering
  \begin{subfigure}{0.325\textwidth}
