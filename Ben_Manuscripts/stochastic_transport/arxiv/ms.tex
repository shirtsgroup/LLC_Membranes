%\documentclass[aps,pre,twocolumn,showpacs,preprintnumbers,amsmath,amssymb,footinbib]{revtex4-1}
...
%  \vspace{1.1cm}
%  \includegraphics[width=0.4\textwidth]{NaGA3C11.pdf}%
%  \vspace{0.6cm}
%  }\hfill
%  \subfloat[\label{fig:membrane_profile}]{%
%    \includegraphics[width=\textwidth]{membrane_profile.pdf}%
%  }\hfill
%  \caption{}\label{fig:membrane_profile}
%  \end{subfigure}
