...
\begin{enumerate}[label={Comment \theenumi :}, leftmargin=3.9\parindent]
  ...
  \item \textit{\textbf{Figure 5 page 25:} \\
		...
		We have modified the plots in the figure to have larger, more readable font and we took this opportunity
		to increase the font size on Figures 6--8 as well.
