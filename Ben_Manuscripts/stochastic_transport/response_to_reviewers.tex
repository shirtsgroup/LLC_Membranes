...
\begin{enumerate}[label={Comment \theenumi :}, leftmargin=3.9\parindent]
  ...
  \item \textit{\textbf{Figure 5 page 25:} \\
		...
		well as the captions in order to further aid the reader in reading them. We also made efforts to cut
...
%	      molecule with two hydrophilic hydroxyl groups.
  ...
  \item \textit{\textbf{Page 35 line 12-14}: \\
        ...
        generated by this method lack a firm physical basis as discussed in Section 3.1.2. 
  ...
  \item \textit{\textbf{Page 35 line 20-42:}\\
        ...
        longer. 
	  	...
	  	%MRS: scanning over this, it's probably more important to say that we probably didn't need to do it, since
                %the analytical fit was so good.
	  	Modified text:
	  	\begin{quote}
...
\begin{enumerate}[label={Comment \theenumi :}, leftmargin=3.9\parindent]  
    ...
    Modified text:
    \begin{quote}
    The complex membrane topology (see Figure~\ref{M-fig:membrane_structure}) gives rise to
