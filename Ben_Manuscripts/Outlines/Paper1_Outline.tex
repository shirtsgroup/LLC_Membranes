...
\begin{document}
	...
	\begin{itemize}
		...
		\item The arrangement of sodium ions (which are closely bound to carbonyl head groups) can be fit to a gaussian distribution % BJC: supplemental info probably
