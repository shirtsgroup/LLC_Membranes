...
%MRS: ^^^nice way to turn a weakness of the materials class into an opportunity to improve them requring research! 
	...
	We varied the relative interlayer orientation between sandwiched and parallel-displaced based on our knowledge of the stability of these two pi-stacking modes.
        \begin{itemize}
		\item Simulated Xray diffraction patterns generated from initial configurations of each pi-stacking mode, shows a clear relation between the parallel displaced configuration and major features present in the XRD patterns %BJC: A figure would probably be good here
