\chapter{Supporting Information to Chapter 2}
  ...
  ionic conductivity using the Nernst-Einstein relationship and collective diffusion model. \\ \hline
  ...
  \section{Number of monomers per column}\label{S-section:monomers_per_column}
...
%	  undesired metastable free energy basin.  
	...
	(Figure~\ref{S-fig:p2p_39}). %After 400 ns, the pore spacing is 4.05 $\pm$ 0.17 nm.
%		There is a large uncertainty in this value because the 1-4 pore spacing
%		(Figure~\ref{S-fig:p2p_diagram}) deviates significantly from all other pore
...
%                towards cubic packing.
	...
	mol$^{-1}$ nm$^{-2}$ (Figure~\ref{S-fig:p2p_41}). %After 400 ns, the
...
%		are the same.}~\label{fig:p2p_diagram}
  ...
  (Figures~\ref{S-fig:sandwiched}--\ref{S-fig:tshaped})~\cite{sinnokrot_estimates_2002}.
  ...
  \begin{figure}[!htb]
        ...
        \begin{subfigure}[b]{0.32\textwidth}
                ...
                \caption{}\label{S-fig:sandwiched}
        \end{subfigure}
        \begin{subfigure}[b]{0.32\textwidth}
                \centering
                \includegraphics[width=\textwidth]{PD.png}
                \caption{}\label{S-fig:pd}
        \end{subfigure}
        \begin{subfigure}[b]{0.32\textwidth}
                \centering
                \includegraphics[width=\textwidth]{Tshaped.png}
                \caption{}\label{S-fig:tshaped}
        \end{subfigure}
        \vskip\baselineskip
        \begin{subfigure}[b]{0.475\textwidth}
                \centering
                \includegraphics[width=\textwidth]{sandwichedlayers.png}
                \caption{}\label{S-fig:sandwichedlayers}
        \end{subfigure}
        \begin{subfigure}[b]{0.475\textwidth}
                \centering
                \includegraphics[width=\textwidth]{offsetlayers.png}
                \caption{}\label{S-fig:offsetlayers}
        \end{subfigure}
        \caption{(a) Sandwiched benzene dimers stack 3.8 \AA~apart. (b) Parallel-Displaced benzene dimers stack
        3.4 \AA~vertically and 1.6 \AA~horizontally apart. (c) T-shaped benzene dimers stack 5.0 \AA~apart.
        (d) Monomers stacked in the sandwiched configuration (e) Monomers stacked in the parallel-displaced
        configuration.}\label{S-fig:stacking}
  \end{figure}

  Based on evidence from Section~\ref{section:rpi} of the main text, we
  ...
  \section{Calculation of pore-to-pore spacing statistics}\label{S-section:p2p_stats}
...
%  \end{figure}
  ...
  \section{Component radial density functions}\label{S-section:radial_density}
...
%  \end{figure}  
 ...
 %BJC: add plot of collective diffusion values 
  ...
  \section{Cross-linking algorithm details}\label{S-section:xlink}

  Cross-linking of the the monomer Na-GA3C11 occurs via a UV initiated free
  ...
  \caption{Terminal vinyl groups present on each monomer tail react with free
	  ...
	  cross-linking.}\label{S-fig:xlink_mech}
  \end{figure}
...
%  \section{Measurement of intensities of experimental and simulated XRD patterns}\label{S-section:xrd_intensities}
%  
...
%  Figure~\ref{S-fig:ralkanes}. The top region is excluded because, in the simulated
%  patterns, R-$\pi$ intersects with R-alkanes.
%  
%  R-$\pi$ and R-double are reported as the maximum values of the peaks of the 
%  $q_z$ cross-section of the experimental pattern at $q_r=0$ (Figure~\ref{S-fig:rpi_rdouble}).
...
%  highlighted in red in Figure~\ref{S-fig:rspots}. If there are no easily discernible
...
%  \end{figure}
  ...
  \centering
  \begin{subfigure}{\linewidth}
  \includegraphics[width=\textwidth]{pore_radius.pdf}
  \end{subfigure}
  ...
  \clearpage
%  \section{Experimental correlation length of R-$\pi$}\label{S-section:correlation_length}
% 
%  \vspace{1em}
...
%  Figure ~\ref{S-fig:waxs_dashed}. We removed background noise by subtracting the
...
%  R-alkanes (Figure~\ref{S-fig:correlation_length_exp}). The full width at half
...
%  \vspace{1em} \\
  ...
  \section{The effect of imposed tail tilt}\label{S-section:tail_tilt}
  ...
  \begin{figure}[!htb]
        ...
        $60\degree$ which is indicative of hexagonal packing. (c) We repeated the 
  ...
  It seems likely that the discrepancy between the shape and intensity of
...
%                \caption{}\label{S-fig:water_filled_pores}
%        \end{subfigure}
%        \begin{subfigure}{0.45\textwidth}
%                \includegraphics[width=\textwidth]{water_removed.png}
%                \caption{}\label{S-fig:water_removed}
%        \end{subfigure}
...
%	  pore region leaving an aqueous solution of water and sodium ions.}\label{S-fig:water_pores}
%  \end{figure}

% BJC: a lot of this is in the main text, but there is some other potentially usefull stuff in here
%  \section{Demonstrative Fourier transforms}\label{S-section:fourier}
%  
...
%
%  \subsection{Magnitude of R-$\pi$}\label{S-section:rpi_ft}
%  
...
%  In Figure~\ref{S-fig:z_correlation}, we fit a decaying sinusoidal function 
%  (equation~\ref{eqn:decaying_sinusoid} of the main text) to $g(z)$ calculated from the
...
%  In Figure~\ref{S-fig:theoretical_correlation_functions}, we overlay the same decaying sinusoidal
%  fit with a function that continues to oscillate with the same amplitude as the third peak of
%  the fit to $g(z)$. In Figure~\ref{S-fig:power_spectrum_comparison}, we plot the power spectrum
%  generated from the discrete Fourier transform of the plots in Figure~\ref{S-fig:theoretical_correlation_functions}. 
...
%  \caption{}\label{S-fig:z_correlation}
%  \end{subfigure}
%  \begin{subfigure}{0.32\textwidth}
%  \includegraphics[width=\textwidth]{theoretical_correlation_functions.png}
%  \caption{}\label{S-fig:theoretical_correlation_functions}
%  \end{subfigure}
%  \begin{subfigure}{0.32\textwidth}
%  \includegraphics[width=\textwidth]{power_spectrum_comparison.png}
%  \caption{}\label{S-fig:power_spectrum_comparison}
%  \end{subfigure}
...
%  intensity of the peaks when the function does not decay to 1.}\label{S-fig:rpi_ft}
%  \end{figure}
%  
%  \subsection{Simplified assemblies}\label{S-section:simplified_assemblies}
%  
...
%  section~\ref{section:rdouble} of the main text.
%  
%  \begin{figure}[!htb]
%  \centering
%  \begin{subfigure}{0.45\textwidth}
%  \includegraphics[width=\textwidth]{simple_sandwich_realspace.png}
%  \caption{}\label{S-fig:simple_sandwich_realspace}
%  \end{subfigure}
%  \begin{subfigure}{0.45\textwidth}
%  \includegraphics[width=\textwidth]{simple_sandwich_rzplot.png}
%  \caption{}\label{S-fig:simple_sandwich_rzplot}
%  \end{subfigure}
%  \begin{subfigure}{0.45\textwidth}
%  \includegraphics[width=\textwidth]{simple_offset_realspace.png}
%  \caption{}\label{S-fig:simple_offset_realspace}
%  \end{subfigure}
%  \begin{subfigure}{0.45\textwidth}
%  \includegraphics[width=\textwidth]{simple_offset_rzplot.png}
%  \caption{}\label{S-fig:simple_offset_rzplot}
%  \end{subfigure}
%  \caption{}\label{S-fig:simple_FTs}
%  \end{figure}
  ...
  \label{S-fig:solvation}

  \end{figure}
  
  \clearpage
  \section{The role of water in the appearance of R-double}\label{S-section:rdouble}
  ...
  We quantified the occurrence of pairing interactions by binning the $z$-positions of the center of mass of 
  ...
  \begin{figure}[!htb]
  \centering
  \includegraphics[width=0.45\textwidth]{water_removed_rdouble.png}
...
%  \caption{}\label{S-fig:rdouble_offset_solvated_rzplot}
%  \end{subfigure}
%  \begin{subfigure}{width=0.45\textwidth}
%  \includegraphics[width=\textwidth]{rzplot_pore1_removed.png}
%  \caption{}\label{S-fig:rzplot_pore1_removed}
%  \end{subfigure}
...
%  (b) When we remove }\label{S-fig:pore1_removed}
%  \end{figure}
  ...
  cross-linked (xlink) system versus an uncross-linked system. The sandwiched configuration (S)
