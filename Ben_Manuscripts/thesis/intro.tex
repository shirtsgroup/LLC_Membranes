...
%  \end{itemize}
  ...
  %MRS3: more figures almost always good. 
...
%MRS3: Next bit seems a bit weird. If you making a transition to what you will be studying, it should be higher in indent level, since now you are switching to what you present. But if this is just a brief aside, maybe it should be left out, and then presented later?
...
%MRS3: liquid crystal-based self-assembled nanostructures?  It's the structures that are of interest.
...
%MRS3: is this last bit necessarily implied (symmetry of phasae bby symmetry of salt)?  It's not clear to me it is.
  ...
  %MRS3: one issue is that after this paragraph, it's not entirely
  %clear where you are going.  This describes common models, but not
  %how your research is placed in respect to them.
...
%MRS: below: same, or qualitatively similar, or substantially similar? Think about a bit more. 
