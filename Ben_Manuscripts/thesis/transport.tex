\chapter{Chemically Selective Transport in the H\textsubscript{II} Phase}\label{chapter:transport}
  ...
  %\graphicspath{{./figs/}}
  %\graphicspath{{/home/bcoscia/PycharmProjects/LLC_Membranes/Ben_Manuscripts/transport/figures}}
  ...
  Table~\ref{S-table:python_scripts_transport} of the Supporting Information. We ran all 
